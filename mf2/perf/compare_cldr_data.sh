...
(cd swift/MessageFormat2 && swift run MessageFormat2Conformance --number-core-bench ../../conformance/fixtures/number-core/cases.json "$ITERATIONS" "$WARMUP_ITERATIONS")
(cd swift/MessageFormat2 && swift run MessageFormat2Conformance --date-time-core-bench ../../conformance/fixtures/date-time-core/cases.json "$ITERATIONS" "$WARMUP_ITERATIONS")
