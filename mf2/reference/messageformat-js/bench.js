...
for (const item of ours) {
  console.log(formatResult(`ours:${item.name}`, bench(() => formatMessage(item.model, item.arguments, { locale: "en", bidiIsolation: "none" }).value)));
...
console.log(formatResult("ours:corpus", bench((index) => {
  ...
  return formatMessage(item.model, item.arguments, { locale: "en", bidiIsolation: "none" }).value;
})));
