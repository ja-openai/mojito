...
public final class TranslateDemo {
    ...
    public static void main(String[] args) throws Exception {
        Catalog catalog = Catalog.load(Path.of("../examples/catalog.json"), SampleCatalogFunctions.registry());
    ...
    private record Catalog(Map<String, Object> messages, Mf2FunctionRegistry functions) {
        ...
        String translate(
            ...
            Mf2FormatResult result = Mf2ModelDecoder.fromJson(model).format(
                    arguments,
