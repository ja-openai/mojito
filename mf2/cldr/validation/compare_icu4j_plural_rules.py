...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--generated-python",
        default="generated/all/python/cldr_plural_rules.py",
...
def load_generated_rules(path: Path) -> Any:
    ...
    sys.path.insert(0, str(path.parents[4] / "python" / "src" / "mojito_mf2"))
    spec = importlib.util.spec_from_file_location("cldr_plural_rules", path)
