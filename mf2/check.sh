...
(cd swift/MessageFormat2 && swift run MessageFormat2Conformance --number-core)
(cd swift/MessageFormat2 && swift run MessageFormat2Conformance --date-time-core)
(cd swift/MessageFormat2 && swift run MessageFormat2TranslateDemo)
(cd python && sh run.sh conformance)
(cd python && sh run.sh number-core)
(cd python && sh run.sh date-time-core)
(cd python && sh run.sh test)
(cd python && sh run.sh demo)
(cd kotlin && sh run.sh conformance)
(cd kotlin && sh run.sh number-core-check)
(cd kotlin && sh run.sh date-time-core-check)
...
(cd java && sh run.sh number-core-check)
(cd java && sh run.sh date-time-core-check)
