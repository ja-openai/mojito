...
- JavaScript/Python top-level locale recovery: public formatter entrypoints now
  coerce the `locale` option before creating formatter state and convert
  throwing host-object stringification failures into an empty parts result with
