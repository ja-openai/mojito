...
- V113 belongs to Mojito's migration history (V109 on the older queue base).
  Do not export Mojito's migration
...
The 2026-09-09 verification below applied V109 explicitly; the current integration
uses the byte-identical V113 fixture SQL.
...
The consumer alone selects V113 fixture resources and applies them explicitly;
