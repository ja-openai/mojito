...
every target before implementation. If V109 was applied, or its unapplied status
cannot be established, require a **new forward migration** for authority changes;
do not edit [MySQL V109](../../webapp/src/main/resources/db/migration/V109__Async_Job_Queue.sql#L1)
or [PostgreSQL V109](../../webapp/src/main/resources/db/postgresql/migration/V109__Async_Job_Queue.sql#L1).
...
| Ambiguous historical null rows, duplicates, missing variants; applied/unknown V109 | No inferred winner or blanket conversion; adoption blocked pending evidence. Forward upgrade preserves old checksums/data. |
