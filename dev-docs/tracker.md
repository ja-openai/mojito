...
- QUEUE-03 — Decide the external admin surface for queue inspection/replay. The bounded service layer can list failed jobs, inspect payloads, and requeue terminal failures; remaining work is UI/API exposure, authorization review, and whether replay actions need explicit audit logging.
