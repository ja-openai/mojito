...
- GLOSSARY-11 — Harden raw term-index curation after the first glossary workspace pass: add structured metadata rendering for seeded candidates, a bulk candidate import UI for non-MCP users, manual split/merge review controls, duplicate/alias clustering, and filters for ignored/accepted suggestions. See `dev-docs/design/013-glossary-raw-term-index.md`.
