...
- REVIEW-01 — Build daily review-project automation on top of `ReviewFeature`: collect `REVIEW_NEEDED` strings by feature, exclude content already in open review projects, and decide whether initial ownership is team queue, vendor queue, or soft person auto-assignment.
