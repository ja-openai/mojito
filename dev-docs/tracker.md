...
- PLATFORM-02 — Finish MCP tools for the new `translation_incident` workflow: explicit reject against a stored incident and create+auto-reject only when the incident resolves to a clear single-candidate case.
