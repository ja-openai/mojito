...
- PLATFORM-03 — Remove AspectJ and annotation/proxy-driven cross-cutting behavior in small commits. Prefer explicit imperative transaction, retry, pollable-task, security-context, timing, and serialization code over AspectJ or Spring AOP. See `dev-docs/design/015-aspectj-removal.md`.
