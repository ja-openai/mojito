...
- QUEUE-03 — Extend operator visibility beyond status gauges for failed async jobs: list/search recent failures, inspect `last_error`/payload metadata, and provide a safe replay or dead-letter handling path.
