...
- GLOSSARY-15 — Finish source terminology review resolution: terminology review projects now cover glossary-backed terms with specialist-input and PM-resolution phases; remaining work is candidate/extracted-term promotion, cross-vendor/teamless review workflow decisions, and richer owner-side metadata edits.
