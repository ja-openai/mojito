...
- QUEUE-01 — Wire the JDBC async job queue into the `assetlocalize` child-job path behind a feature flag using `AsyncJobQueueSubmissionService`, including pollable-task finalization and canary metrics.
