...
public class ReviewSearchQueryIntegrationTest extends ServiceTestBase {
  ...
  @Autowired ReviewProjectRepository reviewProjectRepository;
  ...
  @Test
  public void recomputeReviewProjectDecidedCountsSupportsPostgresSyntax() {
    assertThat(reviewProjectRepository.recomputeDecidedCountsByRequestId(-1L)).isZero();
  }
}
