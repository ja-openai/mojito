...
public class AsyncJobRecordTest {
  ...
  @Test
  public void legacyNonPortablePayloadsRemainReadableWithoutNormalization() {
    for (String payload : new String[] {"old\0input", "old\uD800input", "old\uDC00input"}) {
      AsyncJobRecord record =
          new AsyncJobRecord(
              ...
              NOW,
              false);
      assertThat(record.jobData()).isSameAs(payload);
      assertThat(record.withLeaseReclaimed(true).jobData()).isSameAs(payload);
    }
  }
