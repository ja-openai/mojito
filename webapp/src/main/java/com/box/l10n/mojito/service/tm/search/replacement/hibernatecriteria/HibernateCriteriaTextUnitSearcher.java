package com.box.l10n.mojito.service.tm.search.replacement.hibernatecriteria;

import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.ASSET_DELETED;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.ASSET_EXTRACTION_ID;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.ASSET_ID;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.ASSET_PATH;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.ASSET_TEXT_UNIT_ID;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.BRANCH_ID;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.COMMENT;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.CREATED_DATE;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.DO_NOT_TRANSLATE;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.INCLUDED_IN_LOCALIZED_FILE;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.LAST_SUCCESSFUL_ASSET_EXTRACTION_ID;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.LOCALE_ID;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.NAME;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.PLURAL_FORM;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.PLURAL_FORM_OTHER;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.REPOSITORY_NAME;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.SOURCE;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.STATUS;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.TARGET;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.TARGET_COMMENT;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.TARGET_LOCALE;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.TEXT_UNIT_COUNT;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.TEXT_UNIT_WORD_COUNT;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.TM_TEXT_UNIT_CREATED_DATE;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.TM_TEXT_UNIT_CURRENT_VARIANT_ID;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.TM_TEXT_UNIT_ID;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.TM_TEXT_UNIT_VARIANT_ID;
import static com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport.USAGES;
...
import com.box.l10n.mojito.service.tm.search.replacement.TextUnitSearchCriteriaSupport;
...
/**
 * Candidate replacement for {@code nativeCriteria-core} using Hibernate's Criteria extension API.
 *
 ...
 */
@Service
public class HibernateCriteriaTextUnitSearcher {

  private final EntityManager entityManager;

  public HibernateCriteriaTextUnitSearcher(EntityManager entityManager) {
  ...
  public List<TextUnitDTO> search(TextUnitSearcherParameters searchParameters) {
    ...
    boolean usesAssetTextUnitUsages =
        TextUnitSearchCriteriaSupport.usesAssetTextUnitUsages(searchParameters);
    ...
    return typedQuery.getResultList().stream()
        .map(
            tuple ->
                TextUnitSearchCriteriaSupport.toTextUnitDTO(
                    tuple, searchParameters.getAssetTextUnitUsages() != null))
        .toList();
  }
  ...
  private SearchContext buildSearchContext(
    ...
    if (TextUnitSearchCriteriaSupport.usesAssetTextUnitUsages(searchParameters)) {
  ...
  private Predicate textSearchPredicate(
    ...
    TextUnitTextSearch textSearch =
        TextUnitSearchCriteriaSupport.effectiveTextSearch(searchParameters);
    List<Predicate> predicates =
        TextUnitSearchCriteriaSupport.predicates(textSearch).stream()
    ...
    return TextUnitSearchCriteriaSupport.isOr(textSearch)
  ...
  private Predicate textSearchPredicate(
    ...
    String value = TextUnitSearchCriteriaSupport.normalizeTextSearchValue(predicate);
    ...
    return switch (predicate.getField()) {
      ...
      case TM_TEXT_UNIT_IDS ->
          context.textUnit.get("id").in(TextUnitSearchCriteriaSupport.parseTextUnitIds(value));
    };
  }
  ...
  private Predicate searchTypePredicate(
    ...
    return switch (effectiveSearchType) {
      ...
      case CONTAINS -> cb.like(column, TextUnitSearchCriteriaSupport.containsPattern(value), '\\');
