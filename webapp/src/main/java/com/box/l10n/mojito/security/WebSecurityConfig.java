    ...
    http.authorizeHttpRequests(
        authorizeRequests ->
            authorizeRequests
                ...
                .hasAnyRole("PM", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/admin/linguist-time-spent/report/results/*")
                .hasAnyRole("PM", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/admin/linguist-time-spent/recompute")
                .hasRole("ADMIN")
                .requestMatchers(
                ...
                .hasRole("ADMIN")
                .requestMatchers(
                    HttpMethod.POST, "/api/review-features", "/api/review-features/batch-upsert")
                .hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/review-features/*")
                .hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/review-features/*")
                .hasRole("ADMIN")
                .requestMatchers(
                    HttpMethod.GET, "/api/review-automations", "/api/review-automations/*")
                .hasRole("ADMIN")
                .requestMatchers(
                    HttpMethod.POST,
                    "/api/review-automations",
                    "/api/review-automations/batch-upsert")
                .hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/review-automations/*")
                .hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/review-automations/*")
                .hasRole("ADMIN")
