...
public interface AsyncJobHandler {
   ...
   * The supplied job record is a terminal {@link AsyncJobStatus#DONE} snapshot. Exceptions are
   * logged and metered by the runtime because the queue row is already done.
   */
   ...
   *
   * <p>The supplied job record is a terminal {@link AsyncJobStatus#FAILED} snapshot.
   */
