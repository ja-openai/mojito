...
import './admin-glossaries-page.css';
...
export function AdminGlossariesPage() {
  const user = useUser();
  ...
  const closeCreateModal = () => {
    ...
    if (searchParams.get('create') === '1') {
      void navigate('/settings/system/glossaries', { replace: true });
    }
  };
  ...
  }, [location.search, resetCreateDrafts]);
          ...
          <div className="glossary-admin-page__create-modal">
            ...
            <div className="settings-field">
              ...
              <RepositoryMultiSelect
                label={
                  newScopeModeDraft === 'GLOBAL' ? 'Excluded repositories' : 'Selected repositories'
                }
        ...
        <ConfirmModal
          ...
          body={
            glossaryPendingDelete
              ? `Delete ${glossaryPendingDelete.name}? This removes the glossary configuration only.`
              : ''
          }
          confirmLabel="Delete"
          cancelLabel="Cancel"
      ...
      <div className="glossary-admin-page__cell glossary-admin-page__name-cell">
        <div className="glossary-admin-page__name-group">
          <Link
            ...
            to={`/settings/system/glossaries/${glossary.id}`}
          >
            {glossary.name}
          </Link>
        ...
        <div className="glossary-admin-page__actions">
          <Link className="glossary-admin-page__row-action-link" to={`/glossaries/${glossary.id}`}>
            Terms
          </Link>
          <Link
