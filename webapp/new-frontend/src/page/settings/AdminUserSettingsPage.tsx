  ...
  return (
    <div className="settings-subpage">
      <SettingsSubpageHeader
        ...
        title="Users"
      />
      <div className="settings-page settings-page--wide user-admin-page">
        <div className="user-admin-page__toolbar">
          ...
          <button
            ...
            onClick={() => {
              void navigate('/settings/system/users/batch');
            }}
          >
            Create users
          </button>
                ...
                return {
                  ...
                  props: {
                    ...
                    onClick: (event) => {
                      ...
                      void navigate(`/settings/system/users/${row.id}`);
                    },
                    onKeyDown: (event) => {
                  ...
                  content: (
                    <>
                      ...
                      <div
                        className="user-admin-page__cell user-admin-page__cell--muted"
                        role="cell"
                      >
                        {row.id}
                      </div>
