...
public abstract class RepoCommand extends Command {
  ...
  protected static final String INTEGRITY_CHECK_DESCRIPTION =
      "Integrity Checker by File Extension, comma seperated format: \"FILE_EXTENSION_1:CHECKER_TYPE_1,FILE_EXTENSION_2:CHECKER_TYPE_2\"\n       "
          + "Available Checker types: MESSAGE_FORMAT, MF2, MESSAGE_FORMAT_DOUBLE_BRACES, PRINTF_LIKE, PRINTF_LIKE_IGNORE_PERCENTAGE_AFTER_BRACKETS, PRINTF_LIKE_VARIABLE_TYPE, PRINTF_LIKE_ADD_PARAMETER_SPECIFIER, SIMPLE_PRINTF_LIKE, COMPOSITE_FORMAT, WHITESPACE, TRAILING_WHITESPACE, HTML_TAG, FORMATJS, DOLLAR_TEMPLATE, FORMATJS_RICH_TEXT, ELLIPSIS, BACKQUOTE\n       "
